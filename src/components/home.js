...
Notes & To-dos:/
- fix the centering
- remove toothless creature
- fix periods on fun facts
- fix link (e..g to pulley?)
- check on https
  ...
  render(){
    return(
      <div className = "container placement">
        <h1>Hey there - if you wanna chat about startups, cap tables, email automation, or getting hired at startups, ping me at filip [at] tryimpossible [dot] com</h1>
        // <h1>Hi, I'm Fil.</h1>
        // <br />
